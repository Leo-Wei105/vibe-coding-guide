...
```mermaid
flowchart LR
    A["1️⃣ 点击登录"] --> B["2️⃣ 选择方式"] --> C["3️⃣ 选择套餐"] --> D["4️⃣ 完成"]
```
...
block-beta
    ...
    block:menu:3
        m1["File"] m2["Edit"] m3["Selection"] m4["View"] m5["Go"] m6["Run"] m7["Terminal"] m8["Help"]
    end
...
Windows:
1. 完全关闭Cursor
2. 删除 %APPDATA%\Cursor 文件夹
3. 重新打开Cursor

Mac:
1. 完全关闭Cursor
2. 删除 ~/Library/Application Support/Cursor
3. 重新打开Cursor
```
